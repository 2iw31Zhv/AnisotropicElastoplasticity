...
void HybridSolver::gridCollisionHandling_(Eigen::MatrixX3d& gridVelocityChanges)
{
	...
	if (mesh_ != nullptr)
	{
		VectorXd vertexIsFixed(vertexOmegas_.rows());
		vertexIsFixed.setZero();
		vertexIsFixed.segment<4>(0).setOnes();
